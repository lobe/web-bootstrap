...
function Camera() {
    ...
    return (
        ...
        <div class="box">
            ...
            <div class="greenprogress" style={{position:'absolute', top:'700px', left:'120px', margin: 'auto'}}>
                <div id="predlabel" style={{color:'#ffffff', fontSize:"25px", position:'absolute', top:'10px',  left:'30px'}}> {label} </div>
                <Line id="predprob" percent={prob} trailColor="#33987A88" trailWidth="7" strokeLinecap="square" strokeWidth="7" strokeColor="#00DDAD" style={{transition: '0.5s ease'}}/>
            </div>
        </div>
